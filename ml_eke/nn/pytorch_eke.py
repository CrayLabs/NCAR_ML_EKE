...
if __name__ == '__main__':
    ...
    X_train = np.load('../../notebooks/data/X_train_cf_all_4.npy')
    X_test = np.load('../../notebooks/data/X_test_cf_all_4.npy')

    y_train = np.load('../../notebooks/data/y_train_cf_all_4.npy')
    y_test = np.load('../../notebooks/data/y_test_cf_all_4.npy')
